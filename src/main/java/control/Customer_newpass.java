 ...
 * @author Admin
 */
public class Customer_newpass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Customer_newpass</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Customer_newpass at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!password.equals(confirmPassword)) {
            ...
            boolean updateSuccess = userDB.changePass(email, password);
            if (updateSuccess) {
