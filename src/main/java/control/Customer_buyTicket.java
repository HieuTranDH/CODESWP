    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (showtimeIdParam != null) {
            try {
                ...
                request.setAttribute("errorMessage", "Showtime ID is invalid.");
            }
        } else {
            request.setAttribute("errorMessage", "Showtime ID is required.");
        }

        // Đưa thông tin ghế vào request
        request.setAttribute("seats", seats);
        request.setAttribute("showtimeId", showtimeIdParam);
// Chuyển tiếp tới JSP để hiển thị thông tin ghế
